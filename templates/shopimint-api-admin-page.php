...
<main>
  <div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
        <div class="row">
            <div class="col-md-6">
                <img src="https://app.shopimint.com/backend/static/logo.png" style="width:200px" />
            </div>
            <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin-bottom:20px; display:none;" id="letsbuildsection" >
            <div class="alert alert-warning" role="alert" style="border-radius:10px;">
                ...
                <a href="https://app.shopimint.com/#/auth/sign_up" target="_blank">
                    <button type="button" class="btn btn-dark btn-sm">Let's Build Amazing App</button>
                </a>
            </div>
        </div>
        ...
        <div class="col-md-6" style="margin-bottom:20px;">
            <div class="h-100 p-3 rounded-3" style="background-color:#f0f0f0; border-radius:10px; ">
                <small style="float:left;">Billing Status</small>
    ...
    <div class="p-5 mb-4 bg-light rounded-3" style="margin-top:10px;">
        <div class="row">
            <div class="col-md-6">
                <h1 class="display-5 fw-bold">Shopimint App Builder</h1>
                <p id="demo">
                ...
                <a href="https://app.shopimint.com" target="_blank">
                    <button class="btn btn-primary btn-md" type="button">Let's Start Building</button>
                </a>
            </div>
            <div class="col-md-6">
                <img src="https://app.shopimint.com/backend/static/woobanner.png" style="width:100%" />
            </div>
        </div>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-4">
        <div class="h-100 p-3 rounded-3" style="background-color:#cce6ff; border-radius:10px;">
          ...
          <button class="btn btn-sm btn-outline-dark" type="button">Read More</button>
        </div>
      </div>
      <div class="col-md-4">
